...
public class ClassBelly {
    ...
    public ClassBelly(String tips,int pic,String direct,String attention,int directpic) {
        this.tips = tips;
        this.pic = pic;
        this.direct = direct;
    ...
    public static ArrayList<ClassBelly> init() {
        ...
        int[] directpic = {
                ...
                R.drawable.alter1,};
        ArrayList<ClassBelly> arrayList = new ArrayList();
        for (int i = 0; i < tips.length; i++) {
            ClassBelly belly = new ClassBelly(tips[i],pics[i],direct[i],attention[i],directpic[i]);
            arrayList.add(belly);
        }
        return arrayList;
    }
