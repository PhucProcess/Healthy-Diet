...
public class ClassBiceps {
    ...
    public ClassBiceps(String tips,int pic,String direct,String attention,int directpic) {
        this.tips = tips;
        this.pic = pic;
        this.direct = direct;
    ...
    public static ArrayList<ClassBiceps> init() {
        String[] tips = {"Cable Rope Hammer Curls", "Incline Dumbbell Curl", "Seated Cable Rows", "EZ-Bar Preacher Curl", "Standing Barbell Curl"};
        String[] direct ={
                "Direct:\n" +
        ...
        int[] directpic = {
                ...
                R.drawable.ez1,
                R.drawable.stangding1,};
        ArrayList<ClassBiceps> arrayList = new ArrayList();
        for (int i = 0; i < tips.length; i++) {
            ClassBiceps biceps  = new ClassBiceps(tips[i],pics[i],direct[i],attention[i],directpic[i]);
