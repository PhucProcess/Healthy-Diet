...
public class ClassButt {
    ...
    public ClassButt(String tips,int pic,String direct,String attention,int directpic) {
        this.tips = tips;
        this.pic = pic;
        this.direct = direct;
    ...
    public static ArrayList<ClassButt> init() {
        ...
        int[] directpic = {
                ...
                R.drawable.alter1,};
        ArrayList<ClassButt> arrayList = new ArrayList();
        for (int i = 0; i < tips.length; i++) {
            ClassButt butt = new ClassButt(tips[i],pics[i],direct[i],attention[i],directpic[i]);
            arrayList.add(butt);
        }
        return arrayList;
    }
