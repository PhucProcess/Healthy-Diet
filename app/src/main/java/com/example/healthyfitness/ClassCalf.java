...
public class ClassCalf {
    ...
    public ClassCalf(String tips,int pic,String direct,String attention,int directpic) {
        this.tips = tips;
        this.pic = pic;
        this.direct = direct;
    ...
    public static ArrayList<ClassCalf> init() {
        ...
        int[] directpic = {
                ...
                R.drawable.alter1,};
        ArrayList<ClassCalf> arrayList = new ArrayList();
        for (int i = 0; i < tips.length; i++) {
            ClassCalf calf = new ClassCalf(tips[i],pics[i],direct[i],attention[i],directpic[i]);
            arrayList.add(calf);
        }
        return arrayList;
    }
