...
public class ClassChest {
    ...
    public ClassChest(String tips,int pic,String direct,String attention,int directpic) {
        this.tips = tips;
        this.pic = pic;
        this.direct = direct;
    ...
    public static ArrayList<ClassChest> init() {
        String[] tips = {"Cable Fly", "Close-Grip Bench Press", "Single-Arm Dumbbell Bench Press", "Plyometric Pushup", "Band or Chain Barbell Bench Press"};
        String[] direct ={
                "Direct:\n" +
        ...
        int[] pics = {
                R.drawable.cablefly,
                R.drawable.closegripbenchpress0,
                R.drawable.singlearmdumbbellbench,
                R.drawable.plyometricpushup,
                R.drawable.band,};
        int[] directpic = {
                R.drawable.cablefly1,
                R.drawable.closegripbenchpress,
                R.drawable.singlearmdumbbellbench1,
                R.drawable.plyometricpushup1,
                R.drawable.band1,};
        ArrayList<ClassChest> arrayList = new ArrayList();
        for (int i = 0; i < tips.length; i++) {
            ClassChest chest = new ClassChest(tips[i],pics[i],direct[i],attention[i],directpic[i]);
            arrayList.add(chest);
        }
        return arrayList;
    }
