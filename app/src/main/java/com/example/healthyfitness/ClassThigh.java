...
public class ClassThigh {
    ...
    public ClassThigh(String tips,int pic,String direct,String attention,int directpic) {
        this.tips = tips;
        this.pic = pic;
        this.direct = direct;
    ...
    public static ArrayList<ClassThigh> init() {
        ...
        int[] directpic = {
                ...
                R.drawable.alter1,};
        ArrayList<ClassThigh> arrayList = new ArrayList();
        for (int i = 0; i < tips.length; i++) {
            ClassThigh thigh = new ClassThigh(tips[i],pics[i],direct[i],attention[i],directpic[i]);
            arrayList.add(thigh);
        }
        return arrayList;
    }
