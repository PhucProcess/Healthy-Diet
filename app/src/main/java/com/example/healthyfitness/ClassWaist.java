...
public class ClassWaist {
    ...
    public ClassWaist(String tips,int pic,String direct,String attention,int directpic) {
        this.tips = tips;
        this.pic = pic;
        this.direct = direct;
    ...
    public static ArrayList<ClassWaist> init() {
        String[] tips = {"Ordinary forearm plank", "Side jackknives", "oblique V crunch", "Heel touchers", "Windshield wipers"};
        String[] direct ={
                "Direct:\n" +
        ...
        int[] pics = {
                ...
                R.drawable.oblique0,
                R.drawable.heel,
                R.drawable.windshield,};
        int[] directpic = {
                R.drawable.ordinay1,
                R.drawable.side1,
                R.drawable.oblique,
                R.drawable.heel1,
                R.drawable.windshield1,};
        ArrayList<ClassWaist> arrayList = new ArrayList();
        for (int i = 0; i < tips.length; i++) {
            ClassWaist waist = new ClassWaist(tips[i],pics[i],direct[i],attention[i],directpic[i]);
            arrayList.add(waist);
        }
        return arrayList;
    }
