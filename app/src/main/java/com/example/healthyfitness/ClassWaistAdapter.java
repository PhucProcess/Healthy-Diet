...
public class ClassWaistAdapter extends RecyclerView.Adapter <ClassWaistAdapter.ViewHolder> {
    Context context;
    int layout;
    ArrayList<ClassWaist> arrayList;
    public ClassWaistAdapter(Context context, int layout, ArrayList<ClassWaist> arrayList) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ClassWaist waist = arrayList.get(position);
        holder.ShowHint.setText(waist.getName());
        holder.ShowPic.setImageResource(waist.getPic());
        holder.ShowDirect.setText(waist.getDirect());
        holder.ShowImageDirect.setImageResource(waist.getImageDirect());
        holder.ShowAttention.setText(waist.getAttention());
    }
